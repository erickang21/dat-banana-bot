...
class Info(commands.Cog):
    ...
    async def stats(self, ctx):
        ...
        em.add_field(name='Creator', value=str(self.bot.get_user(304737539846045696)))
        em.add_field(name='Devs', value=str(self.bot.get_user(292690616285134850)))
        ...
        em.add_field(name='Latency :ping_pong: ', value=f"{self.bot.latency * 1000:.2f} ms")
        ...
        em.add_field(name='Bot Uptime :clock:', value="%d days, %d hrs %d mins, %d secs" % (day, hour, minute, second)) 
